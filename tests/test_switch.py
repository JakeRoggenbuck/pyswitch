...
class TestSwitch(unittest.TestCase):
    def setUp(self):
        from pyswitch.switch import Switch
    ...
    def test_multi_case_add(self):
        ...
        self.new_switch.case(2, b1, parameters)
        ...
        self.new_switch.case(2, b2, parameters)
